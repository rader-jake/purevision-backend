...
function normalizeClientOptions(options) {
    ...
    const headers = (0, headers_1.mergeHeaders)({
        ...
        "Square-Version": (_a = options === null || options === void 0 ? void 0 : options.version) !== null && _a !== void 0 ? _a : "2026-05-20",
...
function normalizeClientOptionsWithAuth(options) {
    ...
    (_a = normalized.authProvider) !== null && _a !== void 0 ? _a : (normalized.authProvider = new BearerAuthProvider_1.BearerAuthProvider(normalizedWithNoOpAuthProvider));
    return normalized;
}
